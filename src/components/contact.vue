...
<div class="form-group">
  ...
  <div class="col-md-4 inputGroupContainer">
    <div class="input-group" v-bind:class="{ 'has-error' : errors.has('first_name') }">
        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        <input name="first_name" v-validate="'required|alpha|min:3'" class="form-control" type="text" id="firstName1" placeholder="First Name..." 
              v-bind:class="{ 'input': true, 'has-error': errors.has('firstName1') }" >
    </div>
